          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/images/top1_1200_630.jpg" class="d-block w-100" style="background-color: #2b7b8e26" />
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/images/logo_big_slide.png" /><!-- コピー元が間違っていた（修正済み） -->
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/images/top2_1200_630.jpg" class="d-block w-100" /><!-- コピー元が間違っていた（修正済み） -->
                <div class="carousel-caption d-none d-md-block">
